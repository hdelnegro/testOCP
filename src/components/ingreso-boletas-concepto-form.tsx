...
export function IngresoBoletasConceptoForm() {
      ...
      <Card className="border-l-4 border-l-primary-500">
        <CardHeader className="!p-0">
          <div className="border-b text-center py-3 bg-primary-500 rounded-t-lg">
            <h2 className="text-sm font-bold uppercase text-white">INGRESO DE BOLETAS</h2>
          </div>
        </CardHeader>
        <CardContent className="p-0">
          ...
          <div className="grid grid-cols-[200px_1fr] border-b">
            <div className=" border-r p-2 flex items-center">
              <span className="text-xs font-medium">F_PROCESO</span>
            </div>
            <div className="p-2">
              <Input className="h-8 text-xs" type="date" defaultValue="2022-12-05" />
            </div>
          ...
          <div className="grid grid-cols-[200px_1fr] border-b">
            <div className=" border-r p-2 flex items-center">
              <span className="text-xs font-medium">N° PROCESO</span>
            </div>
            <div className="p-2">
              <Input className="h-8 text-xs" defaultValue="1010" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-[200px_1fr]">
            <div className=" border-r p-2 flex items-center">
              <span className="text-xs font-medium">CONCEPTO</span>
            </div>
            <div className="p-2">
              <Input className="h-8 text-xs" defaultValue="esc" />
            </div>
          </div>
        </CardContent>
      </Card>
